...
class config {
  ...
  public static $default = array(
    ...
    // paths
    'root' => 'content/', // root path relative to script / empty is same as files app location
    ...
    'load_images_max_filesize' => 50000000, // maximum file size (bytes) for un-resized images loaded into list
